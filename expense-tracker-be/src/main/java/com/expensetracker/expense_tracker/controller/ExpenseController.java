...
public class ExpenseController {
    ...
    @PostMapping
    @CacheEvict(value = "expenseAnalysis", key = "#currentUser.id")
    public ResponseEntity<ApiResponse<String>> addExpense(@AuthenticationPrincipal User currentUser, @Valid @RequestBody ExpenseRequest request) {
    ...
    @DeleteMapping("/{id}")
    @CacheEvict(value = "expenseAnalysis", key = "#currentUser.id")
    public ResponseEntity<ApiResponse<Void>> deleteExpense(@AuthenticationPrincipal User currentUser, @PathVariable Long id) {
    ...
    @Cacheable(value = "expenseAnalysis", key = "#currentUser.id")
    @GetMapping("/analyze")
    public ResponseEntity<ApiResponse<String>> analyzeExpenses(@AuthenticationPrincipal User currentUser) {
